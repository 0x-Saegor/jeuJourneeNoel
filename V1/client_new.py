...
lblName = tk.Label(topFrame, text = "Player Number (1,2,3,4 or 5):").pack(side=tk.LEFT)
...
def connect():
    ...
    if len(entName.get()) < 1 or entName.get() not in ["1", "2", "3", "4", "5"]:
        tk.messagebox.showerror(title="ERROR!!!", message="You MUST enter a valid player number <e.g. 1>")
    else:
